...
using Animatable = MasteringWpf.DataModels.Animatable;
using IAnimatable = MasteringWpf.DataModels.Interfaces.IAnimatable;
using System.Windows.Media.Animation;

namespace MasteringWpf.Views.Panels
{
    /// <summary>
