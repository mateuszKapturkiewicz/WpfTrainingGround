...
namespace MasteringWpf.Views.Attached
{
    /// <summary>
    ...
    public class TextBoxProperties : DependencyObject
    {
        ...
        public static readonly DependencyProperty IsNumericOnlyProperty 
            = DependencyProperty.RegisterAttached("IsNumericOnly", typeof(bool), typeof(TextBoxProperties), new UIPropertyMetadata(default(bool), OnIsNumericOnlyChanged));
        ...
        {
            return textBox.SelectedText.Length > 0 ? string.Concat(
                textBox.Text.Substring(0, textBox.SelectionStart), 
                input, 
                textBox.Text.Substring(textBox.SelectionStart + textBox.SelectedText.Length)) 
